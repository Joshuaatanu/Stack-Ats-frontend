...
export default function Home() {
  return (
        ...
        <div class="mx-auto max-w-7xl">
          <div class="flex flex-wrap px-8 md:px-6">
            ...
            <div class="w-full lg:w-5/12 text-center lg:text-left my-auto">
              <h1 class="text-slate-700 font-bold text-4xl">
                Streamline Your School's Admissions Process with StackATS
              </h1>
              <p class="text-slate-500/70 text-lg mt-5">
              ...
              <a href="/register" class="mt-5 text-white btn">
                Get Started Today
              </a>
            </div>
    ...
    <!-- END about section --> */}
          ...
          <div class="grid grid-cols-1 mt-10 ml-6 gap-6 max-w-7xl mx-auto md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="px-6 py-8 bg-white rounded-xl shadow-vague">
              <img
                ...
                class="w-7"
              />
              <h3 class="font-bold text-1xl mt-5">
      ...
      <section class="relative pt-40">
        <div
          class="mx-auto max-w-7xl bg-gradient-to-r from-sky-400 to-sky-300 rounded-none xl:rounded-2xl lg:p-20 p-5 sm:pb-10 md:pb-0 text-center items-center 
        ...
        >
          <div class="grid items-center grid-cols-1 md:grid-cols-2 px-8 md:p-10">
            ...
            <div class="mt-10 md:mt-20 lg:mt-0 mb-20 lg:mb-0 lg:items-center w-full text-white my-auto">
              ...
              <p class="text-lg mt-5 md:text-sm">
              ...
              <a
                href="/register"
                class="mt-6 text-sky-400 rounded-full bg-white p-4 font-semibold"
              >
                Get Started Today
              </a>
            </div>
        ...
        <div class="mx-auto max-w-7xl">
          <div class="grid lg:grid-cols-6 lg:gap-10 gap-20">
            ...
            <div class="lg:col-span-2">
              <a href="/">
                <img src="src/images/logo.svg" alt="logo image" class="w-40" />
              </a>
            ...
            <div class="">
              <ul class="text-lg md:text-md">
                ...
                <li>
                  <a
                    href="#"
                    class="text-slate-500 hover:text-sky-400 duration-200"
                  >
                    FAQ
                  </a>
                </li>
            ...
            <div class="lg:col-span-2">
              ...
              <div class="border border-slate-600 mt-5 rounded-full w-[90%] md:w-[60%] lg:w-full">
                ...
                <div class="p-1.5 flex justify-between">
                  <input
                    class="font-semibold text-white lg:text-sm outline-none bg-transparent ml-3"
                    type="email"
                    placeholder="123@example.com"
                  />
                  <button
                    type="submit"
                    class="px-6 py-4 lg:p-2.5
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 md:justify-between">
            <p class="mb-5 md:mb-0 text-slate-500">
