    ...
    <header className="absolute sticky mx-auto p-3 lg:p-0 left-0 top-0 z-50 bg-white/90 w-full backdrop-blur">
      <div className="lg:mx-auto max-w-7xl mx-5 w-auto mt-5">
       <div className="relative flex h-full items-center justify-between my-auto">
              {/* <!-- logo --> */}
              <a href="/">
                  <img src="/src/images/logo.svg"  alt="logo" className="w-32 lg:w-40"/>
                </a>
                {/* <!-- Nav Toggle Button --> */}
          ...
          <a href="#" className="hover:text-slate-400 duration-200">About</a>
          <a href="#" className="hover:text-slate-400 duration-200">How It Works</a>
          <a href="#" className="hover:text-slate-400 duration-200">Contact</a>

          {/* <!-- get started button --> */}
          <a href="/register" className="btn px-8 text-white text-center text-md">Get Started</a>
          </div>
       </div>
       </div>
    </header>
